...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`${opensans.className} filter drop-shadow-md lg:px-24 h-20 px-2 border-b-2 border-gray-400 relative flex flex-wrap items-center justify-between py-3 bg-gray-950 mb-3 z-50`}
      >
          ...
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <div className="w-full relative flex flex-row justify-center items-center ">
              <Image
                ...
                height={50}
                alt="logo"
                className="lg:w-full lg:h-full w-16 h-16"
              />
              <Link
            ...
            >
              ...
              <div className="flex flex-col bg-gray-950 lg:flex-row list-none">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-md font-medium bg-pink-600 hover:bg-pink-700"
                >
                  Logout
                </button>
                {/* </Link> */}
